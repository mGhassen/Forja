-- dealPortal account feature flag (default off).
-- Admin setter + enforce in deal_iptv_portals before credit burn.

-- ---------------------------------------------------------------------------
-- Admin: set dealPortal feature flag
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Deal: require features.dealPortal before burning credits
-- ---------------------------------------------------------------------------
