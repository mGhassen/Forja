...
import { a as useAuth, n as cn } from "./utils-BshMKIch.mjs";
import { a as useRouterState, f as Link } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-header-_V616WVj.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						...
						children: [
							LINKS.map((link) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavLink, {
								to: link.to,
								exact: link.exact,
								onNavigate: close,
								variant: "mobile",
...
//#endregion
export { SiteHeader as n, BrandLogo as t };
