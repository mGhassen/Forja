...
import { a as SYNC_DOMAINS, d as useUserSetting, n as AccountSettingsShell, o as emptyIptvPayload, u as portalKey } from "./sync-domains-C0TgAES7.mjs";
import { t as Input } from "./input-tsNMiz--.mjs";
import { t as Label } from "./label-D3h4O29f.mjs";
import { n as Star, t as Trash2 } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/account.settings.iptv-DV-toAoe.js
...
function AccountSettingsIptvPage() {
	const { data, isLoading, save, isSaving, saveError } = useUserSetting(SYNC_DOMAINS.iptv);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AccountSettingsShell, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Xtream portals" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: "Panel URL plus username and password — same fields as in the IPTV tab." })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
			className: "space-y-4",
			children: [
		...
		})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "M3U playlists" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: "Remote playlist URLs refresh in the app. File uploads stay device-local." })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
			className: "space-y-4",
			children: [
