...
//#region node_modules/.nitro/vite/services/ssr/assets/account.settings.iptv-zXs0ct--.js
				...
				addOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: cn("rounded-md px-3 py-1.5 text-sm", addMode === "share" ? "bg-forja-green font-bold text-[#0B0A0A]" : "bg-white/5 text-forja-muted"),
							onClick: () => setAddMode("share"),
							children: "Share code"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: cn("rounded-md px-3 py-1.5 text-sm", addMode === "manual" ? "bg-forja-green font-bold text-[#0B0A0A]" : "bg-white/5 text-forja-muted"),
							onClick: () => setAddMode("manual"),
							children: "Manual"
						})]
					}), addMode === "share" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-3",
						children: [
