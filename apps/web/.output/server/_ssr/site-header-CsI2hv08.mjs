...
//#region node_modules/.nitro/vite/services/ssr/assets/site-header-CsI2hv08.js
...
function NavLink({ to, children, exact = false, onNavigate, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
		...
		activeOptions: { exact },
		onClick: onNavigate,
		className: (state) => cn("site-nav-link", state.isActive && "is-active", className),
		children
	});
}
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
						...
						children: [
							...
							!loading && user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								...
								className: (state) => cn("site-login-btn", state.isActive && "is-active"),
								children: "Account"
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					children: [
						...
						!loading && user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/account",
							onClick: close,
							className: "site-login-btn mt-2 w-full",
							children: "Account"
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/login",
							onClick: close,
