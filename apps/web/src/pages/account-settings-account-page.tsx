...
export function AccountSettingsAccountPage() {
  ...
  return (
    <AccountSettingsShell
      section="account"
      title="Your account"
      description="Manage the Forja cloud account used for sync. Profile settings (IPTV, playback, navigation, providers, Stremio) stay under Profile in the sidebar."
    >
      <SettingsSection
        label="Signed in"
