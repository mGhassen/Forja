  ...
  return (
    <>
      <AccountSettingsShell
        title="Forja plugins"
        description="Plugin packs on your profile sync to the app — same list as Settings → Sources → Forja."
        footer={
      ...
      >
        <SettingsSection
          ...
          description="Paste a manifest URL (https://…/manifest.json) or pick a pack from the Plugins catalog."
        >
