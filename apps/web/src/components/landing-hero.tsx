...
/** Marketing hero - clear product pitch, download + packs CTAs. */
    ...
    <header className="relative pt-16 sm:pt-24">
      <div className="relative mx-auto grid w-full max-w-[1500px] items-center gap-8 px-[5vw] pb-12 pt-6 sm:pb-16 sm:pt-10 lg:grid-cols-[0.9fr_1.2fr] lg:gap-10 lg:pb-24 lg:pt-14">
        <div className="hero-enter max-w-xl">
          <h1 className="font-disp text-[clamp(34px,8vw,64px)] uppercase leading-[0.92] tracking-[-0.04em]">
            Free modular
            <br />
          ...
          <p className="mt-5 max-w-lg text-base leading-relaxed text-[rgba(237,230,218,0.62)] sm:mt-6 sm:text-lg">
            Forja is a free media player for movies, series, anime, live sport,
            and IPTV. Install community packs to add hubs and sources, then watch
            on Windows, macOS, Linux, and Android TV — with the same player on
            every screen.
          </p>
