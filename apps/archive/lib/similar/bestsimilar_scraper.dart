...
//
// Rust `catalog` crate archived under crates/archive/catalog — restore FFI to enable.

import 'package:flutter/foundation.dart';

Future<Map<String, dynamic>> _archivedCatalogCore(
  Map<String, dynamic> payload,
) async {
  throw UnimplementedError(
    'Similar tab archived — restore crates/archive/catalog + ffi_catalog_json',
  );
}
...
class BestSimilarScraper {
  ...
  static Future<List<BSAutocompleteHit>> autocomplete(String term) async {
    ...
    try {
      final decoded = await _archivedCatalogCore({
        'action': 'autocomplete',
        'query': q,
      });
