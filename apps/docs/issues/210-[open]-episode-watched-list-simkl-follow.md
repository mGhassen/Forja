...
| 5 | I210-T05 | Manual QA — mark / unmark / finish series on Lists + Simkl | ⬜ |
...
Episode toggle only wrote local checkmarks + tracker **history**. Lists tabs and Simkl **library status** (Watching / Completed) never moved. Wire list follow from the same marks (manual + auto ≥85%).
