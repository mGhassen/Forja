function extract(ctx) {
  var cfg = ctx.config || {};
  var megaplay = String(cfg.megaplay || 'https://megaplay.buzz').replace(/\/$/, '');
  var vidwish = String(cfg.vidwish || 'https://vidwish.live').replace(/\/$/, '');
  var megacloud = String(cfg.megacloud || 'https://megacloud.bloggy.click').replace(/\/$/, '');
  var vidtube = String(cfg.vidtube || 'https://vidtube.site').replace(/\/$/, '');
  var scrapeReferer = cfg.scrapeReferer || 'https://www.enma.lol/';
  var ua =
