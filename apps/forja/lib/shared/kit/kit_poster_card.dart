...
///
/// [KitPosterAspect.portrait] — 2:3 posters. [KitPosterAspect.landscape] — 16:9.
...
class KitPosterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = KitPosterCard.cardWidth(context, aspect: aspect);
    final cardHeight = KitPosterCard.cardHeight(context, aspect: aspect);
