...
import 'package:forja/shared/kit/movie_poster_row.dart';
...
import 'package:forja/shared/kit/kit_list_status_button.dart';
  ...
  Widget _buildHeroTitleBlock(
    ...
    if (movie != null ||
      ...
      return HeroTitle(
        ...
        title: (movie ?? _heroItemAsMovie(heroItem)).title,
