...
/// Thin pack-driven IPTV VOD play — vault portals + Xtream URL shape.
/// Browse UI lives in `forja-packs/hubs/iptv`; this only wires details → player.
abstract final class PackIptvPlayHooks {
  PackIptvPlayHooks._();
  ...
  static void ensureRegistered() {
    ...
    _registered = true;
    KitIptvPlayHooks.hubDetailsParams = _hubDetailsParams;
    KitIptvPlayHooks.resolvePortalFromMeta = _resolvePortal;
    KitIptvPlayHooks.playPortalFromContext = _playFromContext;
