...
export 'package:forja/shared/engine/runtime/kit/panel_source_flags_hooks.dart'
...
Future<void> openKitSources({
  ...
  final resolvedMeta = meta ?? session?.metaItem;
