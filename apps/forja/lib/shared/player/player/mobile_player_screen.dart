...
class _MobilePlayerScreenState extends State<MobilePlayerScreen>
  ...
  Future<void> _configureMpvProperties() async {
    ...
    final mediaKitSafeMode = widget.tvRemoteEnabled || _androidMediaKitSafeMode;
          ...
          body: Stack(
            ...
            children: [
              ...
              Video(
                ...
                if (_showRipple)
                  Positioned(
                    left: _isForward ? null : _ripplePosition.dx - 50,
                    right: _isForward
                ...
                AnimatedOpacity(
                  opacity: (_showControls && !_isLocked && !_isPipMode)
                      ? 1.0
                      : 0.0,
