...
Kit UI calls [`KitDetailsHostHooks`](../../foundation/services/registry/kit_details_host_hooks.dart);
[`TmdbDetailsEnrich.ensureRegistered`](tmdb_details_enrich.dart) wires `TmdbApi`.

Do not put new `TmdbApi` calls in package widgets or `shared/host/kit/` UI.
