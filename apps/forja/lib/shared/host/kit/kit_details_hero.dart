...
import 'package:forja/shared/host/kit/kit_details_facts_panel.dart';
import 'package:forja/shared/host/kit/kit_details_play_row.dart';
import 'package:forja/shared/host/kit/kit_hero_content_scrim.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (useFullWidthList) {
      ...
      if (rich != null) {
        ...
        final panel = KitDetailsFactsPanel(entries: facts);
        hasFacts = panel.hasContent;
        factsChild = hasFacts ? panel : null;
      }
