...
/// extract keeps the hub id in [MetaOpen.extract] `ctx` (e.g. `kisskhId`).
...
///
/// Packs that already put format in [MetaItem.releaseInfo] (anime:
...
/// Overlay badge on [KitPosterCard].
///
