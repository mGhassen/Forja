...
import 'package:forja/shared/host/portals_ui/screens/iptv_series_episode_list.dart';
...
Map<String, dynamic> iptvHubDetailsParams(MetaItem seed) {
...
Future<VerifiedPortal?> resolveIptvPortalFromMeta(MetaItem meta) async {
...
IptvStream iptvStreamFromMeta(MetaItem meta) {
...
Future<void> openIptvVodDetails(
  ...
  if (!context.mounted) return;
  final seed = metaItemFromIptvStream(
    stream: stream,
    portal: portal,
    episodes: episodes,
  );
