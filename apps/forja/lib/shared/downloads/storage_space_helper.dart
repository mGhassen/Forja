...
class StorageSpaceHelper {
  ...
  /// Returns a [StorageSpaceInfo] (fallback assumed size if undetermined).
  static Future<StorageSpaceInfo?> getAvailableSpace(
    ...
    try {
      ...
      if (!kIsWeb && Platform.isWindows) {
        final driveLetter =
            directoryPath.length >= 2 && directoryPath[1] == ':'
  ...
  static Future<bool> hasEnoughSpace(
    ...
    final requiredWithMargin = requiredBytes + (100 * 1024 * 1024);
