...
/// One portal row for [KitPortalListPanel] — opaque display fields only.
class KitPortalListItem {
  const KitPortalListItem({
    required this.id,
    required this.label,
    this.subtitle,
    this.selected = false,
...
class KitPortalListPanel extends StatelessWidget {
  const KitPortalListPanel({
    super.key,
    required this.width,
