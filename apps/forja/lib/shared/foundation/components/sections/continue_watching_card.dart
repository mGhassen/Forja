...
class ContinueWatchingCard extends StatefulWidget {
  ...
  @override
  State<ContinueWatchingCard> createState() =>
      _ContinueWatchingCardState();
}

class _ContinueWatchingCardState
    extends State<ContinueWatchingCard> {
  bool _hovered = false;
  bool _focused = false;
  ...
  Widget build(BuildContext context) {
    ...
    final cardWidth = ContinueWatchingCard.cardWidth(context);
    final cardHeight = ContinueWatchingCard.cardHeight(context);
