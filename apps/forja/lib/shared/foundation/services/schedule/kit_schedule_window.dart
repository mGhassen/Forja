/// Kit schedule sheet axes — Status × Horizon (pre-kit product UX).
...
KitScheduleHorizon? _horizonFromToken(String raw) => switch (raw
    .trim()
    .toLowerCase()) {
      '1h' => KitScheduleHorizon.h1,
      '3h' => KitScheduleHorizon.h3,
      '6h' => KitScheduleHorizon.h6,
      '12h' || '24h' || 'all' || 'day' => KitScheduleHorizon.h24,
      _ => null,
    };
...
bool kitScheduleKickoffMatches({
  ...
  switch (status) {
    case KitScheduleStatus.airing:
      return isLiveNow;
    case KitScheduleStatus.upcoming:
      if (isLiveNow) return false;
    case KitScheduleStatus.both:
