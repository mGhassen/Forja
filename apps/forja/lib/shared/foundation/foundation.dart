...
// Gallery barrel — hide names re-exported via primitives stubs (same types).
...
export 'services/registry/kit_iptv_play_hooks.dart';
export 'services/registry/kit_resolve_streams_hooks.dart';
export 'services/registry/kit_panel_source_flags_hooks.dart';
...
export 'services/follow/kit_list_status_button.dart';
