...
Map<String, dynamic> catalogParamsWithFilters(
  ...
  final merged = MetaFilterAst.andFilters([
    MetaFilterAst.parse(params['filter']),
    ...filters,
  ]);
  return {
    ...params,
