...
class _IptvGuideEpgCardState extends State<IptvGuideEpgCard> {
  ...
  static Color get _accent => LiveShellStyle.accent;
  static Color get _live => LiveShellStyle.liveBadge;
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: LiveShellStyle.surfaceMuted,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: LiveShellStyle.border),
        ),
        child: ClipRect(
          child: child,
        ),
      ...
      child: Row(
        children: [
          _Badge(
            ...
            color: isLive ? const Color(0xFFEF4444) : LiveShellStyle.accent,
            small: true,
          ),
