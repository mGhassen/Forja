...
class ShellBus {
  ...
  /// Switch nav tab from anywhere: `ShellBus.requestTab.value = 'settings';`
  ...
  /// When an old top-level category (debrid, lan, accounts) is requested, this
  /// holds the addon ID to open inside the Addons hub.
