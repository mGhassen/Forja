...
/// Whether [wrapListBody] should hoist past the top bar for this list [sourceId].
typedef KitListBodyHoistPredicate = bool Function(String sourceId);
...
abstract final class KitTopBarHostHooks {
  ...
  /// Opaque gate for stack hoist. Product modules set this with [wrapListBody].
  static KitListBodyHoistPredicate? shouldHoistListBody;
