...
class IptvMovieDetailsScreen extends StatefulWidget {
  ...
  @override
  State<IptvMovieDetailsScreen> createState() => _IptvMovieDetailsScreenState();
}

class _IptvMovieDetailsScreenState extends State<IptvMovieDetailsScreen> {
