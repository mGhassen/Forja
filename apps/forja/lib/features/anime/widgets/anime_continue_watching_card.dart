...
class AnimeContinueWatchingCard extends StatefulWidget {
  ...
  const AnimeContinueWatchingCard({
    super.key,
    required this.entry,
    required this.onTap,
  ...
  @override
  State<AnimeContinueWatchingCard> createState() =>
      _AnimeContinueWatchingCardState();
}

class _AnimeContinueWatchingCardState extends State<AnimeContinueWatchingCard> {
  bool _hovered = false;
  bool _focused = false;
