...
abstract final class ShellTvFocusCoordinator {
  ...
  /// Frame hooks — [bindFrame] from bootstrap (avoids tv→bus/routing imports).
  static ValueListenable<bool>? _playerSurfaceActive;
  static String? Function()? _activeShellTabId;
  static bool Function()? _overlayCanPop;
  static VoidCallback? _overlayMaybePop;

  static void bindFrame({
    required ValueListenable<bool> playerSurfaceActive,
    required String? Function() activeShellTabId,
    required bool Function() overlayCanPop,
    required VoidCallback overlayMaybePop,
  }) {
    _playerSurfaceActive = playerSurfaceActive;
    _activeShellTabId = activeShellTabId;
    _overlayCanPop = overlayCanPop;
    _overlayMaybePop = overlayMaybePop;
  }
  ...
  static bool handleShellExitKey() {
    ...
    if (_playerSurfaceActive?.value == true) {
      return handleShellBackKey();
    }
  ...
  static String _navRestoreTabId(String shellTabId) {
    if (_overlayCanPop?.call() != true) return shellTabId;
