...
import 'package:forja/shared/player/iptv/hooks/iptv_kit_hooks_register.dart';
import 'package:forja/shared/host/layout/portals/portals_chrome_hooks.dart';
...
Future<void> bootstrapForja({String title = 'Forja'}) async {
  ...
  PortalsChromeHooks.ensureRegistered();
