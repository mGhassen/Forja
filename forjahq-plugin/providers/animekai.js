function extract(ctx) {
  ...
  var HEADERS = {
    ...
    Referer: (cfg.origin || 'https://animekai.to') + '/',
  };
  var API = cfg.enc || 'https://enc-dec.app/api';
  var DB = cfg.db || 'https://enc-dec.app/db/kai';
  var AJAX = cfg.ajax || 'https://animekai.to/ajax';
