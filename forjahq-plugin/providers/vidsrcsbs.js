function extract(ctx) {
  ...
  var nxshaOrigin = cfg.nxshaOrigin || 'https://web.nxsha.app';
  var nxshaKey = cfg.nxshaKey || 'S8x!Jk4ZP1uG8$my';
  var videasyApi = cfg.videasyApi || 'https://api.speedracelight.com';
  var videasyOrigin = cfg.videasyOrigin || 'https://player.videasy.to';
