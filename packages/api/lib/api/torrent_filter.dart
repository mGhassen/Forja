...
class TorrentFilter {
  static String normalizeTitle(String title) {
    return TorrentFilterBackend.normalizeTitle?.call(title) ??
        _normalizeTitleDart(title);
  }

  static Map<String, dynamic> parseSceneInfo(String title) {
    return TorrentFilterBackend.parseSceneInfo?.call(title) ??
        _parseSceneInfoDart(title);
  }

  static String _normalizeTitleDart(String title) {
  ...
  static Map<String, dynamic> _parseSceneInfoDart(String title) {
