...
class TorrentFilter {
  static String normalizeTitle(String title) {
    ...
    throw StateError(
      'TorrentFilterBackend.normalizeTitle not wired — call ForjaEngine.init()',
    );
  }
  ...
  static Map<String, dynamic> parseSceneInfo(String title) {
    ...
    if (backend != null) return backend(title);
    throw StateError(
      'TorrentFilterBackend.parseSceneInfo not wired — call ForjaEngine.init()',
    );
  }
  ...
  static Future<List<TorrentResult>> filterTorrentsAsync(
    ...
    // Must run on the main isolate — TorrentFilterBackend hooks are static
    // and are not copied into compute() worker isolates.
