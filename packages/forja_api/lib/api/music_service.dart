...
import 'package:forja_api/services/youtube_audio_extractor.dart';
...
class MusicService {
  ...
  Future<String?> getYoutubeVideoId(String title, String artist) async {
    ...
    // Fast path: YouTube results-page HTML + regex (ported from Forja TV).
    try {
  ...
  Future<String?> getYoutubeStreamUrl(String videoId) async {
    ...
    // Fast path: direct InnerTube call (ported from Forja TV).
    try {
      final fastUrl =
