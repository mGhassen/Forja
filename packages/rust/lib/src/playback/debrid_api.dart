...
class DebridApi {
  ...
  Future<List<DebridFile>> resolveRealDebrid(
    ...
    return _resolve('Real-Debrid', token, magnet, season: season, episode: episode);
  }
  ...
  Future<List<DebridFile>> resolveAllDebrid(
    ...
    return _resolve('AllDebrid', apiKey, magnet, season: season, episode: episode);
  }
  ...
  Future<List<DebridFile>> resolvePremiumize(
    ...
    return _resolve('Premiumize', apiKey, magnet, season: season, episode: episode);
  }
  ...
  Future<List<DebridFile>> resolveDebridLink(
    ...
    return _resolve('Debrid-Link', apiKey, magnet, season: season, episode: episode);
  }
