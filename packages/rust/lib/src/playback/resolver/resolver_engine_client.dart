...
abstract final class ResolverEngineClient {
  static Future<Map<String, dynamic>> resolve({
    ...
    final raw = await EngineJobs.run(EngineAsyncJob.resolverEngineResolve, {
  ...
  static Future<Map<String, dynamic>> continueWithHost({
    ...
    final raw = await EngineJobs.run(EngineAsyncJob.resolverEngineContinue, {
  ...
  static List<PlayableSource> sourcesFromResponse(
