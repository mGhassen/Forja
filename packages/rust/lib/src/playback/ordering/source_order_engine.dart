...
import 'package:rust/src/playback/domain/source_domain.dart';
...
class ProviderOrderRow {
  ...
  factory ProviderOrderRow.fromJson(Map<String, dynamic> json) =>
      ProviderOrderRow(
        id: json['id']?.toString() ?? '',
...
class ProviderOrderResult {
  const ProviderOrderResult({required this.orderedIds, required this.rows});
