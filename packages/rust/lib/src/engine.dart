...
class RustLib {
  ...
  String listProvidersJson() => _readString(_native.ffi_list_providers_json());

  String playbackRankSourcesJson(String payloadJson) => using((arena) {
    final ptr = payloadJson.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(_native.ffi_playback_rank_sources_json(ptr));
  });

  String playbackNormalizeLegacyJson(String payloadJson) => using((arena) {
    final ptr = payloadJson.toNativeUtf8(allocator: arena).cast<ffi.Char>();
  ...
  String decryptPasteResponse(String urlWithHash, String rawResponse) => using((
    arena,
  ) {
  ...
  String opensslAesDecryptJson(String b64, {String passphrase = ''}) => using((
    arena,
  ) {
    final b64Ptr = b64.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    final passPtr = passphrase.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(_native.ffi_openssl_aes_decrypt_json(b64Ptr, passPtr));
  });
  ...
  String parseXtreamStreamsJson(String json, String section) => using((arena) {
    ...
    final sectionPtr = section.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(
  ...
  String stremioHttpGet(String url, {int timeoutSecs = 15}) => using((arena) {
    final ptr = url.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(_native.ffi_stremio_http_get_json(ptr, timeoutSecs));
  });
  ...
  String httpGetJson(
    ...
    return _readString(_native.ffi_http_get_json(urlPtr, timeoutSecs, hdrPtr));
  });
  ...
  String iptvProbeStreamJson(String url, {int timeoutSecs = 8}) => using((
    arena,
  ) {
    final urlPtr = url.toNativeUtf8(allocator: arena).cast<ffi.Char>();
  ...
  String tmdbGetJson(String resourcePath, {int timeoutSecs = 15}) => using((
    arena,
  ) {
    final ptr = resourcePath.toNativeUtf8(allocator: arena).cast<ffi.Char>();
  ...
  String filterTorrentsJson(
    ...
    final resultsPtr = resultsJson
        .toNativeUtf8(allocator: arena)
        .cast<ffi.Char>();
    final titlePtr = showTitle.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(
  ...
  String sortTorrentsJson(String resultsJson, String preference) => using((
    arena,
  ) {
    final resultsPtr = resultsJson
        .toNativeUtf8(allocator: arena)
        .cast<ffi.Char>();
    final prefPtr = preference.toNativeUtf8(allocator: arena).cast<ffi.Char>();
    return _readString(_native.ffi_sort_torrents_json(resultsPtr, prefPtr));
  });
  ...
  String torrentStatusJson() => _readString(_native.ffi_torrent_status_json());
  ...
  String torrentReclaimDiskCacheJson({int targetBytes = -1}) => _readString(
    _native.ffi_torrent_reclaim_disk_cache_json(
...
final class _FfiNative {
  _FfiNative(ffi.DynamicLibrary lib)
    : ffi_free_string = lib
      ...
      ffi_list_providers_json = lib
          .lookup<ffi.NativeFunction<_VersionNative>>('ffi_list_providers_json')
          .asFunction(),
      ffi_playback_rank_sources_json = lib
          .lookup<ffi.NativeFunction<_StringInOutNative>>(
            'ffi_playback_rank_sources_json',
          )
          .asFunction(),
      ffi_playback_normalize_legacy_json = lib
          .lookup<ffi.NativeFunction<_StringInOutNative>>(
      ...
      ffi_parse_m3u_json = lib
          .lookup<ffi.NativeFunction<_StringInOutNative>>('ffi_parse_m3u_json')
          .asFunction(),
      ...
      ffi_http_get_json = lib
          .lookup<ffi.NativeFunction<_HttpGetNative>>('ffi_http_get_json')
          .asFunction(),
      ffi_http_post_json = lib
          .lookup<ffi.NativeFunction<_HttpPostNative>>('ffi_http_post_json')
          .asFunction(),
      ...
      ffi_torrent_status_json = lib
          .lookup<ffi.NativeFunction<_VersionNative>>('ffi_torrent_status_json')
          .asFunction(),
      ...
      ffi_lan_server_stop = lib
          .lookup<ffi.NativeFunction<_TorrentStopNative>>('ffi_lan_server_stop')
          .asFunction(),
      ...
      ffi_lan_pairing_code = lib
          .lookup<ffi.NativeFunction<_VersionNative>>('ffi_lan_pairing_code')
          .asFunction(),
      ...
      ffi_seek111477_stop = lib
          .lookup<ffi.NativeFunction<_TorrentStopNative>>('ffi_seek111477_stop')
          .asFunction(),
      ...
      ffi_storage_get_json = lib
          .lookup<ffi.NativeFunction<_StorageKeyNative>>('ffi_storage_get_json')
          .asFunction(),
      ffi_storage_set_json = lib
          .lookup<ffi.NativeFunction<_StorageSetNative>>('ffi_storage_set_json')
          .asFunction();
  ...
  ffi_pick_episode_index_json;
  final int Function(ffi.Pointer<ffi.Char>) ffi_pick_largest_video_index_json;
...
typedef _EpisodeMatchesNative =
    ffi.Bool Function(ffi.Pointer<ffi.Char>, ffi.Int32, ffi.Int32);
typedef _PickEpisodeIndexNative =
    ffi.Int32 Function(ffi.Pointer<ffi.Char>, ffi.Int32, ffi.Int32);
typedef _PickLargestVideoIndexNative =
    ffi.Int32 Function(ffi.Pointer<ffi.Char>);
typedef _FilterTorrentsNative =
...
typedef _StremioHttpGetNative =
    ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>, ffi.Uint64);
typedef _HttpGetNative =
    ffi.Pointer<ffi.Char> Function(
      ffi.Pointer<ffi.Char>,
      ffi.Uint64,
      ffi.Pointer<ffi.Char>,
    );
typedef _HttpPostNative =
    ffi.Pointer<ffi.Char> Function(
      ffi.Pointer<ffi.Char>,
      ffi.Uint64,
      ffi.Pointer<ffi.Char>,
...
typedef _EngineSubmitJobNative =
    ffi.Uint64 Function(ffi.Uint32, ffi.Pointer<ffi.Char>);
typedef _EngineTakeJobNative = ffi.Pointer<ffi.Char> Function(ffi.Uint64);
...
typedef _StoragePathNative =
    ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>);
typedef _StorageKeyNative =
    ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>);
typedef _StorageSetNative =
    ffi.Pointer<ffi.Char> Function(
      ffi.Pointer<ffi.Char>,
      ffi.Pointer<ffi.Char>,
    );
