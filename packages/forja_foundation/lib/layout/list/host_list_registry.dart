...
abstract final class HostListRegistry {
  ...
  /// Host sets this to build unregistered pack-feed sources on demand.
  static KitListSource? Function({
    String? sourceId,
    String? pluginId,
  })? packFeedResolver;
  ...
  /// Full-page host bodies (not the poster list grid).
  ...
  /// Registered source, else host [packFeedResolver] (if set).
  static KitListSource? resolveOrPackFeed({
    ...
    return packFeedResolver?.call(sourceId: sourceId, pluginId: pluginId);
  }
