...
abstract class KitListSource {
  ...
  /// Host list sources leave this null — packs own plugin ids.
  String? get hubPluginId;

  /// When true, host mounts [buildHostBody] instead of the plain list grid.
  ...
  /// the list widget (sibling markNeedsBuild during build).
