//! Generic engine HTTP + metadata + subtitles.
//!
//! Not the Anime hub (that is `plugins/hubs/anime`). Legacy Rust extractors
//! live under `crates/archive/anime` (`anime_extractors`).
