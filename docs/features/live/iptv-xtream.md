...
- On **Live**, hover (or TV-focus) a portal group to show a **pin** control — pinned groups sit under Already watched (newest pin on top); pin state is remembered per portal on this device; Movies / Series have no pins
