...
- On **Live**, the category sidebar includes **Favorites** and **Already watched** under **All** — star a channel to favorite it; opening a live channel adds it to Already watched (last 30 on this device, per portal)
