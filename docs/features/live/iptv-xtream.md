...
- Browse live channels by category — channel tiles and compact list rows show a play control that enlarges and floats upward, plus a slightly brighter border, on hover (desktop) or focus (TV)
