...
- On **Live**, use the top-bar **Sort** control (between search and portals) to order **Categories** and **Content** independently: playlist order, name A–Z, or name Z–A — remembered on this device; Movies/Series stay in portal order
