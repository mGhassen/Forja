...
- Browse live channels by category — catalog shows **alive streams only** (checked in the background)
...
- **Live** catalog only lists streams that passed an alive check (cached per portal; first open may take a moment)
