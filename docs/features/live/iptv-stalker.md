...
- Browse **Live**, **Movies**, and **Series** like Xtream — movies and series open the same Home-style details overlay (TMDB when matched, production info card, Play under synopsis, Cast/Crew/Trailers; series also get episodes; Android TV D-pad matches movie details)
