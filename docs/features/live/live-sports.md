...
- Pick an **Xtream** or **Stalker** portal from top-right **Portals** (same panel as IPTV; needed for **Live TV** matching when Forja Sports is on). On **Android TV**, OK on **Portals** (or → / ↓ while the panel is open) moves D-pad to the **selected** portal in the list — same as the IPTV hub.
