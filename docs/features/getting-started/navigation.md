...
- Open **Settings → Navigation Bar** to toggle tabs on/off, drag to reorder, and star the tab that opens on app start
...
- **Home hero (TV):** DOWN from the top menu (Search / Films / TV Shows / Categories) focuses the **hero gallery** (backdrop carousel); **←/→** change the featured title; UP from the gallery returns to the top menu; DOWN from the gallery focuses **Play**; UP from **Play** (and the info / My List pills) focuses the gallery
