...
- **Home / Anime / Asian Drama hero (TV):** DOWN from the top menu (Search / Films / Series or TV Shows / Categories) focuses the **hero gallery** (backdrop carousel); **←/→** change the featured title and backdrop image; UP from the gallery returns to the top menu; DOWN from the gallery focuses **View details**; UP from **View details** (and My List) focuses the gallery
