...
Forja uses a tab-based shell. Each tab is a full section of the app — Home, Discover, IPTV, Music, Settings, and others. On desktop you get a side rail; on phone and tablet, a bottom navigation bar. You can hide, show, and reorder most tabs to match how you use the app.

## How to open it

The tab bar is always visible after the app finishes loading. **Settings** is always pinned and cannot be hidden.
