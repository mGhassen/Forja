...
- **Home / Anime / Asian Drama / Arabic / Brstej / كرتون menu (desktop):** pack-declared chrome — **Search** (if `search`), then any `filters.menus[]` tabs, then **Categories** when `fields` has options (genre / country / Larozaa section / letter, …)
