...
- **Windows / Linux:** Custom window caption (min / max / close) on the main shell and on pre-shell screens (sign-in, Who’s watching, update gate); in-app updates download the installer with progress. Same arrow-key D-pad focus as macOS / Android TV.
