...
- Open details with episodes — on **TV**, **Play** / **Resume** is focused when the page opens; **↑** from hero actions closes details; **←** from the leftmost hero action moves focus to the shell nav rail; **↑** from episodes or **More Like This** returns focus to **Play**
...
- **Escape** / **Cancel** during resolve leaves to details; once the player is open, Escape returns to details (not the loading screen)
