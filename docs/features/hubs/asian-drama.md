...
- KissKH CDNs disguise segments as `.png` — Forja strips that shell through the local HLS proxy. If a title still BUFFERING near 0:00, try another quality from the player menu
