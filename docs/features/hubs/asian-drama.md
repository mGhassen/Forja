...
- KissKH masters often include 4K rungs that starve on desktop — Forja opens a ≤1080p (or your Settings max stream quality) variant by default, and if the player is still BUFFERING near 0:00 it drops once to a lower rung
