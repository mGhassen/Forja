...
- **Pack rails** — Characters, Staff, Related, Trailers, recommendations — whatever the pack returns after enrich. On **Android TV**, **↑** from Characters walks to episodes (when present) then **Play**; without episodes, **↑** focuses **Play** (no jump to the bottom recommendations row).
