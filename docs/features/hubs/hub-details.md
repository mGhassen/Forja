...
|-----|-------------------|--------|
| **Home** | All enabled Forja providers | Preferred list under **Forja Packs → Home → Green Play** |
| **Anime** | All enabled Forja providers | Preferred list under **Addons → Anime → Green Play** |
| **Asian Drama** | All enabled Forja providers | Preferred list under **Forja Packs → Asian Drama → Green Play** |
