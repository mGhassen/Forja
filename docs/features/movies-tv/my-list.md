...
- Open a title — stays on **My List** in the nav (details overlay; not a jump to Home / Anime). Film / series rows open **TMDB** details; Anime and Asian Drama reopen with that hub’s details and stream providers. On **TV**, entering the tab focuses the first kind tab. **↓** goes to status then the grid; arrow keys move between posters; **←** from the first column returns to the nav rail.
