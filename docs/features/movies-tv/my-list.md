...
- Open a title — stays on **My List** in the nav (details overlay). Opens the hub that owns the title: **TMDB (Home)** for films/series, **Anime** for AniList titles, **Asian Drama** for KissKH titles. On **TV**, entering the tab focuses the first kind tab. **↓** goes to status then the grid; arrow keys move between posters; **←** from the first column returns to the nav rail.
