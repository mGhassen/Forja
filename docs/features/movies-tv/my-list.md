...
- Set **default hubs** per type under **Settings → Data & backup → My List open defaults** (Films / Series / Anime / Asian Drama) — used only when a row has matching ids and no saved hub yet
