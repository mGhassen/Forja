...
- Open a title — details overlay, and the nav switches to the hub that owns it: **Home** for TMDB films/series, **Anime** for AniList titles, **Asian Drama** for KissKH titles (Back leaves you on that hub). On **TV**, entering the tab focuses the first kind tab. **↓** goes to status then the grid; arrow keys move between posters; **←** from the first column returns to the nav rail.
