...
On **TV series**, the backdrop continues below the hero chrome so season and episode rails sit on the image — not on a separate black block. The episode rail reserves ~500px of backdrop at the bottom of the first screen; hero title/actions use the space above so seasons and episodes do not sit mid-hero. When that chrome is tight (short viewports), **Play** / **Resume** stay visible and title/meta shrink or drop rather than overflowing.
