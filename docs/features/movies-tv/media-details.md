...
- For TV: pick a season from the horizontal poster row (multi-season shows) — the hero backdrop crossfades to that season's poster; then tap an episode in the rail to **select** it (does not start playback or open Sources). Use green **Play** / **Resume** for webstreaming, or white **Play** / **Resume** (link icon) / **Download** for Sources. Without Continue Watching, the page opens season 1 unless you have an in-progress episode (2–90%), then that season is selected.
