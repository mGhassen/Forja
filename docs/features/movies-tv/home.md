...
- On **desktop**, drag-select the hero title text to copy it (logo titles are images). Alt-tab / window focus keeps your scroll position — it does not jump back to Spotlight. The selected Spotlight pin fills until the next slide (about 8 seconds); hovering **View details** / the list pin pauses auto-advance (pause icon). On desktop, keyboard focus on those buttons also pauses; mouse-only focus after you move the pointer away does not. On **TV**, D-pad focus on those buttons pauses until you leave.
