...
- On **desktop**, drag-select the hero title text to copy it (logo titles are images). Alt-tab / window focus keeps your scroll position — it does not jump back to Spotlight. The selected Spotlight pin fills until the next slide (about 8 seconds); hovering or focusing **View details** / the list pin pauses auto-advance and shows a pause icon until you leave.
