...
| [Features](navigation-bar.md) | Tab visibility, order, default menu — lists hub tabs from enabled packs and IPTV / Live Sports only after those Addons are on | Always |
