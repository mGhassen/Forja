...
- The first time you turn on **Direct torrent**, **Stremio**, or **Nuvio**, Forja shows a **P2P streaming** disclaimer (IP visible to peers, you are responsible for what you stream, Forja does not host P2P content). Cancel leaves that source off. After you tap **Enable P2P**, **P2P streaming** in this screen stays checked (acknowledged) and the dialog does not appear again on this device. If those sources were already on, the dialog appears the first time you open **Playback**
