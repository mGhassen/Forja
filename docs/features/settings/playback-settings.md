...
> Play sources, external player, audio, and webstreaming provider order.

## What it is

Core playback preferences: which backends **Play** tries on the media details screen, external player, preferred audio language, unsupported codec avoidance, and webstreaming extractor priority.
