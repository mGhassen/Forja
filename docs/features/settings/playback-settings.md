...
- Set **IPTV live recovery** under **Settings → Addons → IPTV** when the **IPTV engine** is **ExoPlayer** (Android). **Auto** / **Stable** / **Classic** only affect Exo reconnect. **MediaKit** ignores this setting (ffmpeg reconnect + silent reopen)
