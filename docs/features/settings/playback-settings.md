...
- Toggle **IPTV programme guide (EPG)** under **Settings → Addons → IPTV**. Shows NOW / NEXT in the IPTV player and browser (on by default). Turning the IPTV addon off clears it; turning IPTV back on restores the default (on)
