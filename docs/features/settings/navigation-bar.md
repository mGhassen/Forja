...
- **Plugin on/off** (Settings → Forja Packs) controls whether a hub feature exists. Turn a pack or hub plugin **on** and its tab defaults **on** in Features / the rail **at the end of the list** (packs do not choose navbar position). Turn it off or **uninstall** the pack and it disappears from Features and the nav rail.
