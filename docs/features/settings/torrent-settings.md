...
- Install **Stremio** / **Nuvio** addons (Stremio rows: switch next to trash enables/disables without uninstall; Sources / Live Sports chips assign surfaces)
...
- On **Android TV**, **Data & backup**, and **Debrid** stay hidden. Configure **Forja addons** under **Settings → Sources** and packs under **Forja Packs** on the TV the same as phone/desktop
