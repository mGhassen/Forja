...
- Open **Settings** popup for auto selection, **Auto skip intro**, speed, aspect ratio, loop, hardware decode, and subtitle style. On desktop torrent sessions, toggle **Torrent stats** (off by default) to show live download/peer info above the seek bar while controls are visible
...
- Jump to next episode for TV content (optional **Auto next episode** — Settings or Episodes panel checkbox)
