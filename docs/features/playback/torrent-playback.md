...
- Switch torrents / Stremio streams mid-playback via the link (magnet) button — opens the same right-side **Sources** panel as media details (**All / Torrents / Stremio**, provider chips, filters, source cards). Picking a result resolves and reloads in-player
