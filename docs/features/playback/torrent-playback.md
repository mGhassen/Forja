...
- On Android TV, Sources lists torrents without pairing; playing a magnet needs a paired desktop in [LAN](../settings/lan.md) (dialog if unpaired — **Back** closes that dialog and stays in the player). Direct HTTP Stremio/Nuvio still play on the TV. Phones can play magnets locally, or via the desktop when paired.
