...
| **5 — Webstreamr** | 24/49 extractors · 12/22 sources | partial | extractors + URL/HTML sources wired |
...
- Webstreamr: 23 extractors + 12 sources (vidsrc/vixsrc/rgshows embed URLs, kinoger show.js, meinecloud/verhdlink/megakino/homecine/mostraguarda/eurostreaming/cinehdplus/streamkiste HTML parse)
...
| Webstreamr URL sources ported | 12 / 22 |
| Dart parity tests | 43 |
