...
**Next phase:** [Phase 2](./02-[fixed]-rust-engine-complete.md)  
...
**Next:** [Phase 2 — Rust engine complete](./02-[fixed]-rust-engine-complete.md)
...
**B2 unlock:** [Phase 2 P2-10](./02-[fixed]-rust-engine-complete.md#b2--mobile-librqbit-critical-path) — mobile magnet via Rust FFI before Flutter delete.
...
| WASM / web client | [RFC-014](../rfc/014-[draft]-v3-web-rust.md) v3.0 — not migration |
| Catalog engine (wave 2) | [Phase 3](./03-[fixed]-engine-catalog.md) |
...
- [Phase 2 — Rust engine complete](./02-[fixed]-rust-engine-complete.md)
- [RFC-009](../rfc/fixed/009-[fixed]-rust-ffi.md)
- [crates/README.md](../../crates/README.md)

Phase 1 is frozen except factual corrections. See [02-[fixed]-rust-engine-complete.md](./02-[fixed]-rust-engine-complete.md) for wave 1 record.