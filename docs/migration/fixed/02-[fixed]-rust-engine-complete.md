...
**Status:** fixed  
**Depends on:** [Phase 1](./01-[fixed]-rust-engine.md)  
**Next phase:** [Phase 3](./03-[fixed]-engine-catalog.md)  
...
| T4 | WebStreamr UI non-blocking | P2-91, [015](../issues/fixed/015-[fixed]-rust-blocking-http-engine-debt.md) | ✅ |
...
- [Phase 1](./01-[fixed]-rust-engine.md) · [Phase 3 catalog](./03-[fixed]-engine-catalog.md) · [ENGINE_BOUNDARY](../ENGINE_BOUNDARY.md) · [RFC-009](../rfc/fixed/009-[fixed]-rust-ffi.md)
