...
| 34 | P2-91 | WebStreamr worker pool + cancel + Rust abort — [001](../issues/001-[fixed]-webstreamr-blocks-ui.md), [015](../issues/015-[fixed]-rust-blocking-http-engine-debt.md) | ✅ |
...
| T4 | WebStreamr UI non-blocking | P2-91, [015](../issues/015-[fixed]-rust-blocking-http-engine-debt.md) | ✅ |
