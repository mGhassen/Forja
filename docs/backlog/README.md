...
|---------------|------------|----------|--------|
| [1.0.1-[open].md](1.0.1-[open].md) | 1.0.x patch checklist | Bab Souika | open — details & player UX (191/209 shipped) |
...
| [1.0.9-[draft].md](1.0.9-[draft].md) | 1.0.x patch checklist | Bab Souika | draft — LAN desktop→TV torrent (5/6; RFC-022 · 026) |
