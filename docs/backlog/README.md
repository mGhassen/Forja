...
|---------------|------------|----------|--------|
| [1.0.1-[open].md](1.0.1-[open].md) | 1.0.x patch checklist | Bab Souika | open — details & player UX (56/65 shipped) |
...
| [1.0.4-[draft].md](1.0.4-[draft].md) | 1.0.x patch checklist | Bab Souika | draft — web portal + landing + Flutter APIs (9/9 code; ops verify) |
