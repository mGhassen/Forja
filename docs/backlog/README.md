...
|---------------|------------|----------|--------|
| [1.0.1-[open].md](1.0.1-[open].md) | 1.0.x patch checklist | Bab Souika | open — details & player UX (249/266 shipped) |
...
| [1.4.0-[draft].md](1.4.0-[draft].md) | 1.4.0 minor checklist | Atarin | draft — Home watch-provider filter (4/5; RFC-057) |
