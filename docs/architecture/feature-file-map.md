...
My List hub pack `plugins/hubs/my_list` + feature host in [`features/my_list/`](../../apps/forja/lib/features/my_list/) and list services in [`shared/foundation/services/follow/`](../../apps/forja/lib/shared/foundation/services/follow/) (RFC-085 — not under catalog kit).
