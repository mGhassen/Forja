...
| **Current slice** | Part 1 ✅ · Live Sports chrome (horizon/view/cards/kind icons/search copy) owned by pack · engine live = feed/resolve only · A16 ✅ · A18 🔄 · **shim death waits Q1–Q12** |
