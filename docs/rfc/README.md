...
| [029-[open]-…](029-[open]-dual-built-in-playback-engines.md) | Dual built-in engines (MediaKit + ExoPlayer) | v1.0.2 | open | 4/4 · 2/8 · 3/3 chrome | [1.0.2](../backlog/1.0.2-[draft].md) |
...
| [053-[partial]-…](053-[partial]-asian-drama-tmdb-details.md) | Asian Drama TMDB details enrichment | v1.0.1 | partial | 4/4 · 6/7 · 3/4 · 2/2 Sources · 1/1 MLT drama | [1.0.1](../backlog/1.0.1-[open].md) — B101-S199 · B101-S210 · smoke R53-A06/A10 ⬜ |
...
| [058-[partial]-…](058-[partial]-structured-search.md) | Structured Search (person / genre / year / score / language) | v1.4 | partial | 3/3 · 5/6 · 5/5 · **4/4** kit capability · **2/2** language | [1.4.0](../backlog/1.4.0-[draft].md) |
...
| [107-[open]-…](107-[open]-iptv-multi-engine-avplayer-vlc.md) | IPTV multi-engine (AVPlayer Mac · VLC Windows · Exo Android) | — | open | **12 / 12** · **19 / 20** · catalog+always-list+chrome+vlc-headers | — |
| [108-[fixed]-…](fixed/108-[fixed]-my-list-open-hub-binding.md) | My List open hub binding (picker + cache) | — | fixed | Complete · 7/7 · 20/20 | — |
| [109-[open]-…](109-[open]-forja-pack-product-host.md) | Forja pack-product host (root = generic engines + frame only) | — | open | **7 / 7** · **8 / 8** law · **26 / 29** code · 4 🔄 · **8 / 8** IPTV pack · **12 / 12** A41 · **3 / 3** wipe · **3 / 3** kit evacuate · **3 / 3** validate+paint · **3 / 3** pack search · **4 / 4** catalog slots · **4 / 4** live guide · **2 / 2** guide out of player · **3 / 3** portal forms · **4 / 5** empty-shell (A79 🔄) | — |
...
| [113-[open]-…](113-[open]-iptv-mediakit-direct-reconnect.md) | IPTV MediaKit — direct CDN + lavf reconnect | — | open | **14 / 14** · **2 / 10** | — |
...
| [117-[open]-…](117-[open]-vod-offline-downloads.md) | VOD offline Downloads (dual entry + Settings) | — | open | **15 / 17** · **21 / 21** | [365](../issues/365-[open]-vod-offline-downloads.md) · [382](../issues/382-[open]-downloads-hub.md) |
