...
| [073-[open]-…](073-[open]-live-sports-kit-ownership.md) | Live Sports kit ownership (kill modes → kit browse → details → platform → teardown → kill live silo → domain home) | v1.4 | open | **3/4** · **4/4** kill · **3/4** kit browse · **3/4** details · **2/2** platform · **4/4** teardown · **3/3** kill silo · **1/1** domain home | — |
...
| [083-[open]-…](083-[open]-in-app-mini-player.md) | In-app mini player (inside Forja — not OS PiP) | v1.4 | open | **9 / 9** · **24 / 24** | — |
