...
| [083-[open]-…](083-[open]-in-app-mini-player.md) | In-app mini player (inside Forja — not OS PiP) | v1.4 | open | **8 / 8** · **17 / 17** | — |
...
| [086-[fixed]-…](fixed/086-[fixed]-addons-packs-feature-vs-navbar.md) | Addons/Packs flag features; Features flags navbar | v1.4 | fixed | **Complete** · **4 / 4** · **14 / 14** | — |
