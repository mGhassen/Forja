...
| [015-[partial]-…](015-[partial]-in-app-updates.md) | In-app updates | v1.0 / v1.1 | partial | 7/7 · 11/13 · 3/3 · 2/2 · 5/5 · 5/6 · 1/1 · 3/3 · 2/3 · 4/4 · 1/1 · 2/2 · 1/1 | [0.0.1](../backlog/done/0.0.1-[done].md), [0.6.3](../backlog/done/0.6.3-[done].md), [1.0.1](../backlog/1.0.1-[open].md), [1.0.2](../backlog/1.0.2-[draft].md), [1.0.4](../backlog/1.0.4-[draft].md) |
...
| [022-[open]-…](022-[open]-lan-server-client.md) | LAN server/client | post-v1.2 | open | 8/8 · 9/10 · 0/12 | [1.0.9](../backlog/1.0.9-[draft].md) · [1.0.1](../backlog/1.0.1-[open].md) |
