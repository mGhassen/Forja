...
| [003-[partial]-…](003-[partial]-player-overlay.md) | Player overlay + server grid | v1.1 | partial | 4/6 · 0/4 | [0.0.1](../backlog/done/0.0.1-[done].md) slice → [1.0.1](../backlog/1.0.1-[draft].md) |
| [004-[partial]-…](004-[partial]-provider-registry.md) | Stream provider registry | v1.0 / v1.1 | partial | 3/3 · 0/3 | [0.0.1](../backlog/done/0.0.1-[done].md) → [1.0.1](../backlog/1.0.1-[draft].md) |
| [005-[partial]-…](005-[partial]-casting.md) | AirPlay + Chromecast | v1.1 | stub | 0/1 · 0/4 | [1.0.1](../backlog/1.0.1-[draft].md) |
...
| [012-[draft]-…](012-[draft]-v1.1-casting-providers.md) | v1.1 casting + providers | v1.1 | draft | 0/8 | [1.0.1](../backlog/1.0.1-[draft].md) |
...
| [019-[draft]-…](019-[draft]-god-file-decomposition.md) | God file splits | v1.1 | draft | 0/5 | [1.0.1](../backlog/1.0.1-[draft].md) |
| [020-[draft]-…](020-[draft]-media-details-routing.md) | Media details routing | v1.1 | draft | 0/4 | [1.0.1](../backlog/1.0.1-[draft].md) |
