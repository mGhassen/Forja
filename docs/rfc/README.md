...
| [109-[open]-…](109-[open]-forja-pack-product-host.md) | Forja pack-product host (root = generic engines + frame only) | — | open | **7 / 7** · **8 / 8** law · **22 / 26** code · 4 🔄 · **8 / 8** IPTV pack · **11 / 12** A41 · **3 / 3** wipe | — |
