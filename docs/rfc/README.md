...
| [073-[open]-…](073-[open]-live-sports-kit-ownership.md) | Live Sports kit ownership (kill modes → kit browse → details → platform → teardown) | v1.4 | open | **2/4** · **4/4** kill · **3/4** kit browse · **3/4** details · **2/2** platform · **4/4** teardown | — |
