...
| [052-[partial]-…](052-[partial]-iptv-progress-aware-recovery.md) | Progress-aware IPTV playback recovery (demuxer probe + backoff) | v1.0.1 | partial | 2/4 · 1/6 | [1.0.1](../backlog/1.0.1-[open].md) |
