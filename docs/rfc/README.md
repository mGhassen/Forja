...
| [109-[open]-…](109-[open]-forja-pack-product-host.md) | Forja pack-product host (root = generic engines + frame only) | — | open | **7 / 7** · **8 / 8** law · **25 / 29** code · 4 🔄 · **8 / 8** IPTV pack · **11 / 12** A41 · **3 / 3** wipe · **3 / 3** kit evacuate · **3 / 3** validate+paint · **3 / 3** pack search · **4 / 4** catalog slots | — |
...
| [112-[open]-…](112-[open]-blocks-json-props.md) | Blocks with JSON props (pack-callable) | — | open | **4 / 4** · **5 / 6** · 1 ⏭️ | — |
