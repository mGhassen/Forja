...
| [052-[partial]-…](052-[partial]-iptv-progress-aware-recovery.md) | Progress-aware IPTV playback recovery (live hard-block + feed probe) | v1.0.1 | partial | 12/13 · 1/10 | [1.0.1](../backlog/1.0.1-[open].md) |
