...
| 16 | R54-A16 | Torrent Sources search consumes [RFC-079](fixed/079-[fixed]-sources-id-middleware.md) id bag (`imdb` + opaque `ids`) | ✅ |
...
- [RFC-079](fixed/079-[fixed]-sources-id-middleware.md) — Sources id bag middleware (torrent consumes shared mapper)
