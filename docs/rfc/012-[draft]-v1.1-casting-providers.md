...
|-----------|------|--------|
| `PlayerOverlayPanel` | `shared/foundation/primitives/feedback/forja_player_overlay.dart` | Mount in desktop/mobile player |
| `ServerGrid` | `shared/foundation/primitives/chrome/forja_server_grid.dart` | Connect to `StreamResolver.switchProvider()` |
| `ForjaPosterCard` | `shared/foundation/primitives/chrome/forja_poster_card.dart` | Use in browse rails (optional) |
