...
**Target version:** [1.0.0 Bab Souika](../backlog/1.0.0-[open].md) (v1.1 polish slice)  
...
| **Backlog** | [0.0.1](../backlog/done/0.0.1-[done].md), [0.6.3](../backlog/done/0.6.3-[done].md), [1.0.0](../backlog/1.0.0-[open].md) |
