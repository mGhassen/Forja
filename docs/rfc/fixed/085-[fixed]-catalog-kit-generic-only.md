...
**Status:** fixed  
**Depends on:** [RFC-070](../070-[partial]-catalog-hub-protocol.md) · [RFC-071](071-[fixed]-live-sports-hub-kit.md) · [RFC-073](073-[fixed]-live-sports-kit-ownership.md)  
...
| | |
|--|--|
| **Progress** | **Complete** · **5 / 5** components · **23 / 23** · **1 / 1** sides |
...
- [RFC-073](073-[fixed]-live-sports-kit-ownership.md) — live schedule kit ownership complete
- [RFC-070](../070-[partial]-catalog-hub-protocol.md) — hub protocol
- [RFC-090](090-[fixed]-live-sports-host-outside-foundation.md) — Live Sports host path outside foundation
