...
**Status:** fixed  
**Depends on:** [RFC-062](062-[fixed]-native-iptv-sports-matching.md) · [RFC-092](092-[fixed]-delete-root-app-live-sports.md) · [RFC-095](095-[fixed]-foundation-design-data-split.md)  
...
| | |
|--|--|
| **Progress** | **Complete** · **3 / 3** · **8 / 8** host cut · **1 / 1** JS Live TV |
...
- [RFC-062](062-[fixed]-native-iptv-sports-matching.md) — Rust matcher + EPG (engine); host policy superseded here
