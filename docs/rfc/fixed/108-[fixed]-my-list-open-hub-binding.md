...
**Status:** fixed  
**Depends on:** [RFC-097](097-[fixed]-my-list-explode-host-to-packs.md) · [RFC-070](../070-[partial]-catalog-hub-protocol.md)  
...
| | |
|--|--|
| **Progress** | **Complete** · **7 / 7** components · **20 / 20** acceptance |
...
- [RFC-097](097-[fixed]-my-list-explode-host-to-packs.md) — My List pack feed
