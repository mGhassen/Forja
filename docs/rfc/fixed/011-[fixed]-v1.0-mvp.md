...
| My List | `plugins/hubs/my_list` + `shared/foundation/services/follow/` | simkl (via host) |
...
Before v1.1 UX work, ship a performance patch: [RFC-016](016-[fixed]-lazy-tab-mounting.md) (lazy tabs), [RFC-017](../017-[open]-deferred-engine-boot.md) (deferred / profile-gated engines), [RFC-018](../018-[draft]-startup-splash-home.md) (splash + Home stagger).
