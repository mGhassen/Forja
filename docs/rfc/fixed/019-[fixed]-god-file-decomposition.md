...
| | |
|--|--|
| **Progress** | **Complete** · **5 / 5** acceptance (v1.1 slice) |
...
|------|-----------------|------|
| [`details_screen.dart`](../../../apps/forja/lib/features/home/details_screen.dart) | 545 | Orchestrator (state, lifecycle, panel coord); 8 `details_screen_*.dart` mixins |
...
3. **Reuse shared widgets** — delete inline duplicates (`_HoverScale`, `_MovieSection`) in favor of [`hover_scale.dart`](../../../apps/forja/lib/shared/foundation/primitives/chrome/hover_scale.dart), [`movie_section.dart`](../../../apps/forja/lib/shared/foundation/components/posters/movie_section.dart)
...
- RFC-020 (media folder move), RFC-003 (player overlay), RFC-001 (feature boundaries), [RFC-025](025-[fixed]-flat-cinematic-shell.md) (optional `home_hero.dart` extract), [RFC-026](../026-[draft]-media-details-player-ux.md) (1.0.1 UX rework — details + player splits required)
