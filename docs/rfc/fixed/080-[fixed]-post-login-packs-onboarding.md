...
**Status:** fixed  
**Depends on:** [RFC-074](../074-[open]-remote-profile-plugin-install.md) · [RFC-068](068-[fixed]-engine-plugin-registry.md)  
...
| | |
|--|--|
| **Progress** | **Complete** · **5 / 5** components · **13 / 13** acceptance |
