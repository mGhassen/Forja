...
**Status:** Shipped (PlayTorrio parity + feature-first architecture)  
...
Engine packages: `forja_core`, `forja_storage`, `forja_api`, `forja_streaming`, `forja_webstreamr`, `forja_scrapers`.
...
| My List | `features/my_list/` | trakt, simkl (via forja_api) |
...
Before v1.1 UX work, ship a performance patch: [RFC-016](016-lazy-tab-mounting.md) (lazy tabs), [RFC-017](017-deferred-engine-boot.md) (deferred engines), [RFC-018](018-startup-splash-home.md) (splash + Home stagger).
