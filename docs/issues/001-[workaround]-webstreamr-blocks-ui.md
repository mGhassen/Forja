...
**Status:** workaround (2026-07-06) — UI no longer freezes; engine root fixed in [015](015-[fixed]-rust-blocking-http-engine-debt.md)  
...
- [x] Cancel token into Rust resolver ([009](009-[workaround]-post-migration-resilience-audit.md))
- [ ] Optional: job API to reduce isolate spawn churn (deferred)
