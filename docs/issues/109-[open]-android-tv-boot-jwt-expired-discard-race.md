...
**Related:** [085](085-[open]-desktop-involuntary-signout-dumps-login.md) (hard `signedOut`) · [106](106-[open]-desktop-session-profile-chrome-desync.md) (idle chrome) · [323](fixed/323-[fixed]-supabase-auth-retryable-dns-blip.md) (DNS `/token` blip soft-handling) · [RFC-042](../rfc/042-[open]-unified-auth-system.md)
