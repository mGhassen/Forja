...
Isolate offload — stops UI freeze but **does not fix** multi-page blocking resolve in `crates/stream-core`. Root fix: [015](015-[open]-rust-blocking-http-engine-debt.md).
...
Track in [015](015-[open]-rust-blocking-http-engine-debt.md): async resolve chain in `crates/stream-core`; cancel token.
