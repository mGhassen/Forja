...
| **Current slice** | T09–T11: stub details/hub under player + cancel background work on enter |
...
| 5 | I120-A05 | Android TV: Home → details → Play does not hitch from details/hub poster decode under the opaque player | ⬜ |
