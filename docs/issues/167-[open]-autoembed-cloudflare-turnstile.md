...
| | |
|--|--|
| **Progress** | **0 / 2** fix tasks · **0 / 2** acceptance |
...
**Not fixed in this slice** — needs API reverse-engineer or FlareSolverr/ops path; do not hide AutoEmbed from the server list.
