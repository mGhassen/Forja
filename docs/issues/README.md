...
| [018-[draft]-…](018-[draft]-migration-playback-parity-unverified.md) | Playback parity unverified | P1 | High | draft | 3/13 | [1.0.0](../backlog/1.0.0-[open].md) |
| [019-[draft]-…](019-[draft]-webstreamr-enginejobs-e2e-test-gap.md) | WebStreamr E2E test gap | P2 | Medium | draft | 0/3 | [1.0.0](../backlog/1.0.0-[open].md) |
| [020-[draft]-…](020-[draft]-cancel-gen-token-discard-unverified.md) | Cancel gen-token unverified | P2 | Medium | draft | 0/3 | [1.0.0](../backlog/1.0.0-[open].md) |
| [021-[draft]-…](021-[draft]-catalog-vertical-import-smoke-unverified.md) | Catalog import smoke unverified | P3 | Low | draft | 0/3 | [1.0.0](../backlog/1.0.0-[open].md) |
| [022-[draft]-…](022-[draft]-playback-widget-integration-tests.md) | No playback widget tests | P3 | Low | draft | 0/3 | [1.0.0](../backlog/1.0.0-[open].md) |
