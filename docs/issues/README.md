...
| [024-[open]-…](024-[open]-local-torrent-mpv-format-probe-race.md) | Local torrent mpv format probe race | P1 | High | open | 8/9 · A 0/2 | [1.0.1](../backlog/1.0.1-[open].md) |
...
| [128-[open]-…](128-[open]-android-tv-iptv-mediakit-exit-anr.md) | ATV IPTV MediaKit exit ANR after Player menu switch | P1 | High | open | 9/9 · A 0/3 | [1.0.1](../backlog/1.0.1-[open].md) |
...
| [136-[open]-…](136-[open]-android-tv-iptv-catalog-guide-scroll-focus.md) | ATV IPTV catalog/guide scroll focus + logos | P1 | Medium | open | 15/15 · A 0/6 · 1⏭️ | [1.0.1](../backlog/1.0.1-[open].md) |
...
| [142-[open]-…](142-[open]-iptv-admin-scrape-watermark-deep-refs.md) | IPTV admin scrape watermark + deep refs + no upsert cap | P1 | High | open | 17/17 · A 0/3 | [1.0.5](../backlog/1.0.5-[draft].md) |
...
| [148-[open]-…](148-[open]-iptv-live-edge-snap-reconnect-loop.md) | IPTV reconnect — Stable / Classic + stall checkbox | P1 | High | open | 12/12 · A 0/11 | [1.0.1](../backlog/1.0.1-[open].md) |
