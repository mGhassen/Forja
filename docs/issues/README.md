...
| [278-[fixed]-…](fixed/278-[fixed]-live-sports-schedule-one-shot-catalog-wait.md) | Live Sports schedule waits for every catalog before paint | P1 | High | fixed | Complete · 4/4 · A 0/2 | [RFC-105](../rfc/fixed/105-[fixed]-live-providers-plugin-search.md) · [RFC-109](../rfc/109-[open]-forja-pack-product-host.md) |
