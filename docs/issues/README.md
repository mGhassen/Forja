...
| [260-[open]-…](260-[open]-host-hardcodes-specific-plugins.md) | Host still hardcodes specific plugins (community-owned audit) | P0 | Critical | open | 2/6 · A 0/4 | [255](255-[open]-provider-runtime-config-builtins-debt.md) |
...
| [273-[fixed]-…](fixed/273-[fixed]-iptv-hls-cold-open-watchdog-kill.md) | IPTV HLS cold open killed by stall soft-reopen | P0 | Critical | fixed | Complete · 6/6 · A 0/2 | [272](fixed/272-[fixed]-iptv-hls-m3u-continuity-proxy-death-spiral.md) |
