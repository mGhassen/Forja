...
| | |
|--|--|
| **Progress** | **Complete** · **7 / 7** fix · **2 / 2** acceptance |
...
| # | ID | Description | Status |
|--:|----|-------------|--------|
| 1 | I254-A01 | Providers lists Streamed / PPV / … mirrors without Live Soccer TV / LiveOnSat; play unlocks via live pack (host unit + schedule-only ingest) | ✅ |
| 2 | I254-A02 | WatchFooty (or peer) fixture with site `Stream links (0)` shows no fake provider row; catalog still lists the match (T07 + unit gate) | ✅ |
