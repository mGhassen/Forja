...
**Area:** `apps/forja/lib/shared/player/screens/`, `packages/api/lib/playback/providers/services/webstreamr_service.dart`, `apps/forja/lib/features/home/streaming_details_screen.dart`, `crates/webstreamr/src/resolver.rs`  
**Reported:** 2026-07-07
## Status at a glance
