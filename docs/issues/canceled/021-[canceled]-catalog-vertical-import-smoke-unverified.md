...
Smoke list cites deleted verticals (`live_matches_screen`, manga, …). Host features evacuated; tracker obsolete as written.
...
| My List | hub pack + `shared/foundation/services/follow/`, kit `my_list_*` | `my_list_service.dart` |
